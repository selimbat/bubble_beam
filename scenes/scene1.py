...
material4 = Material(np.array([1,1,1]),1.,1.,1.,0.9,1.)
...
light2 = Spotlight(np.array([-0.6,2.,1.4]),np.array([0.95,0.1,0.15]))
light3 = Spotlight(np.array([0.6,-2.,1.4]),np.array([0.1,0.9,0.1]))
